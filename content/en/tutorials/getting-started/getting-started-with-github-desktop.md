...
Follow [`Naming Convention for branches`](/coding-standards/git-workflow/branch-naming-convention)
...
Try to keep the summary clear and meaningful, check [`Git Commit Messages`](/coding-standards/git-workflow/git-commit-messages) for more information
