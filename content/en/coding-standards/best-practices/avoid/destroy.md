...
headline: Why You Should Avoid Destroy() in Unity
---
...
Using `Destroy()` forces Unity to free and reallocate memory over and over again. This not only hurts performance but also increases load on the Garbage Collector. [Object pooling](/coding-standards/best-practices/object-pooling) is almost always a better solution.
...
[Click for more](/coding-standards/best-practices/object-pooling)
