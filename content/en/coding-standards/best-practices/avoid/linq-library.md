...
headline: Why You Should Avoid LINQ in Unity
---
...
> ⚠️ But never use LINQ inside [`Update()`](/coding-standards/best-practices/avoid/update), FixedUpdate(), coroutines, or tight gameplay loops.
...
- [Object pools](/coding-standards/best-practices/object-pooling) / managers → Keep organized lists of active objects instead of filtering at runtime.
