...
headline: Overusing GetComponent - Why It’s Bad and How to Avoid It
---
...
- In small projects, this may not be noticeable, but in **larger projects with thousands of objects**, repeated calls inside [`Update()`](/coding-standards/best-practices/avoid/update) or physics loops can cause **serious frame drops**.
- Example:
  ```csharp
  private void Update()
  {
