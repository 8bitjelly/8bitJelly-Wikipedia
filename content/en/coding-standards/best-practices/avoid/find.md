...
headline: Why You Should Avoid Find() in Unity
---
...
- Using `Find()` in [`Update()`](/coding-standards/best-practices/avoid/update) or frequent logic creates **serious performance bottlenecks**.
